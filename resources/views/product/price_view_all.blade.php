...
@section('title', 'Product With Price')
  ...
  <div class="row">
    <div class="col-sm-12 view_all_table_holder" id="view_all_table_holder">
    </div>
  </div>
...
function PriceViewAllAjax(){
  var url = '<?= action('ProductController@PriceViewAllTable') ?>';
  ...
  $.ajax({
    ...
    success:function(result){
      if(result){
        ...
        $('.view_all_table_holder').html(result);
      }
    },
