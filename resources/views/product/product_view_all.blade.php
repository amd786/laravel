...
@section('title', 'View All')
  ...
  <div class="col-sm-7 col-sm-offset-2 padB30 text-center address-text hide">View All</div>
  ...
  <div class="row">
    <div class="col-sm-12 product_view_all_holder" id="product_view_all_holder">
    </div>
  </div>
...
function ProductViewAllAjax(){
  var url = '<?= action('ProductController@ProductViewAllTable') ?>';
  ...
  $.ajax({
    ...
    success:function(result){
      if(result){
        ...
        $('.product_view_all_holder').html(result);
      }
    },
